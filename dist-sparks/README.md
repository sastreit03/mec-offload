# OAI MEC distributed sparks demo code
...
Start with `mec/src/config.yaml` using `vlm.backend: mock` to validate the communication path before enabling the actual model.
